...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/lab1p1-student.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=leds.c timer.c main.c switch.c interrupt.c ../PART2.X/util.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/leds.o ${OBJECTDIR}/timer.o ${OBJECTDIR}/main.o ${OBJECTDIR}/switch.o ${OBJECTDIR}/interrupt.o ${OBJECTDIR}/_ext/1755480198/util.o
POSSIBLE_DEPFILES=${OBJECTDIR}/leds.o.d ${OBJECTDIR}/timer.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/switch.o.d ${OBJECTDIR}/interrupt.o.d ${OBJECTDIR}/_ext/1755480198/util.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/leds.o ${OBJECTDIR}/timer.o ${OBJECTDIR}/main.o ${OBJECTDIR}/switch.o ${OBJECTDIR}/interrupt.o ${OBJECTDIR}/_ext/1755480198/util.o

# Source Files
SOURCEFILES=leds.c timer.c main.c switch.c interrupt.c ../PART2.X/util.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/lab1p1-student.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1755480198/util.o: ../PART2.X/util.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1755480198" 
	@${RM} ${OBJECTDIR}/_ext/1755480198/util.o.d 
	@${RM} ${OBJECTDIR}/_ext/1755480198/util.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1755480198/util.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1755480198/util.o.d" -o ${OBJECTDIR}/_ext/1755480198/util.o ../PART2.X/util.c     
...
${OBJECTDIR}/_ext/1755480198/util.o: ../PART2.X/util.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1755480198/util.o.d 
	@${RM} ${OBJECTDIR}/_ext/1755480198/util.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1755480198/util.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1755480198/util.o.d" -o ${OBJECTDIR}/_ext/1755480198/util.o ../PART2.X/util.c     
...
dist/${CND_CONF}/${IMAGE_TYPE}/lab1p1-student.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/lab1p1-student.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
